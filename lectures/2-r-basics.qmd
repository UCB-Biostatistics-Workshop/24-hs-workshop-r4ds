...
```
```{r, eval=F}
sleep = read_csv("https://raw.githubusercontent.com/UCB-Biostatistics-Workshop/f24/summer-2023/data/ss.csv")
```
```{r, include=F}
sleep = read_csv("https://raw.githubusercontent.com/UCB-Biostatistics-Workshop/f24/summer-2023/data/ss.csv")
```
...
- This code *assigns* the result of running `read_csv("https://raw.githubusercontent.com/UCB-Biostatistics-Workshop/f24/summer-2023/data/ss.csv")` to the name `sleep`
...
```{r, tidy=F}
ggplot(data=sleep) + 
  geom_point(mapping=aes(y=sleep_duration, x=quality_of_sleep))
```
...
```{r, tidy=F} 
ggplot(sleep) + 
  geom_point(aes(quality_of_sleep, sleep_duration))
```
...
```{r setup, eval=FALSE}
file_name = "https://raw.githubusercontent.com/UCB-Biostatistics-Workshop/f24/summer-2023/data/ss.csv"
...
```{r, tidy=F}
ggplot(data=sleep) + 
  geom_point(aes(sleep_duration, quality_of_sleep))
```
