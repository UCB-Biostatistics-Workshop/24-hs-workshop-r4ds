...
```
## Exercise
EH: I want to get rid of this to save time
- Without using the internet, think of how you can use `filter` multiple times to create a dataset where quality of sleep is greater than or equal to 8 **and** stress level is less than or equal to 3

- Using any resources you like, figure out how to use `filter` to create a dataset where **either** quality of sleep is greater than or equal to 8 **or** stress level is less than or equal to 3
```
